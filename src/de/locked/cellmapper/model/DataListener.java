...
public class DataListener extends PhoneStateListener implements
	...
	public void onLocationChanged(Location location) {
		...
		// this might be null!
		String androidRelease = Build.VERSION.RELEASE; // android version like
														// 2.3.7
		String carrier = telephonyManager.getNetworkOperatorName();
		countSatellites();
//		private final String manufacturer = Build.MANUFACTURER; // HTC
...
//		private final String osVersion; // 2.6.37.6-cyanogenmod-01509-g8913be8		
	...
	private void countSatellites() {
		if (gpsstatus == null) {
			onGpsStatusChanged(Integer.MIN_VALUE);
		}
	}
